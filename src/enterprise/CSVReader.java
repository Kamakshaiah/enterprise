...
public class CSVReader {
	...
	public static ArrayList<Integer> csvfileimport(String path) {
		...
		try {
			...
			while((line = br.readLine()) != null) {
				...
				dataOut.add(Integer.parseInt(values[2]));
...
//			System.out.println(dataOut);
			...
			bw.flush(); bw.newLine(); System.out.println("Data flushed!"); bw.close();
	...
	public static void main(String[] args) {
		 ...
		 * dataNew.addAll(csvfileimport("data/emp-salary.csv"));
		 * 
		...
		// csvFileWriteString("this is just a string", "data/output.csv");
